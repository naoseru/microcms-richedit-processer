...
var processer = function (content, options) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    processOptions = merge(defaultOptions, options, {
                    ...
                    return [4 /*yield*/, Promise.all(root
                            ...
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, imgProcesser(imgElement, processOptions)];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, Promise.all(root
                            ...
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, iframeProcesser(iframeElement, processOptions)];
                                case 1: return [2 /*return*/, _a.sent()];
                            }
                        }); }); }))];
                case 3:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, Promise.all(root
                            ...
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, codeProcesser(codeElement, processOptions)];
                                case 1: return [2 /*return*/, _a.sent()];
                            }
                        }); }); }))];
                case 5:
                    ...
                    if (Object.keys(processOptions.otherElements).length !== 0) {
                        ...
                        Object.keys(processOptions.otherElements).forEach(function (key) {
                            root.querySelectorAll(key).forEach(function (element) {
                                var _a;
                                otherElementsProcesser(element, (_a = processOptions.otherElements[key]) !== null && _a !== void 0 ? _a : {});
                            });
                        });
                    }
