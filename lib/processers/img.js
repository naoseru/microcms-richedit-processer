...
var ts_imgix_1 = require("ts-imgix");
    ...
    return __generator(this, function (_h) {
        switch (_h.label) {
            case 0:
                ...
                _a = image_size_1.default;
                return [4 /*yield*/, (0, node_fetch_1.default)(splitSrc[0])
            ...
            case 1:
                ...
                imgixUrl = (0, ts_imgix_1.buildImgixUrl)(splitSrc[0])(imgixParams);
                ...
                srcset = options.img.deviceSizes
                    ...
                    return "".concat((0, ts_imgix_1.buildImgixUrl)(splitSrc[0])(imgixParamsForSrcSet), " ").concat(size, "w");
                })
                    .join(', ');
